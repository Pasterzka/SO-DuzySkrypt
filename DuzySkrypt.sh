#!/bin/bash
# Author           : Jakub Pastuszka 198339 ( s198339@pg.edu.pl / jaku6p@gmail.com)
# Created On       : 30.05.2024
# Last Modified By : Jakub Pastuszka 198339 ( s198339@pg.edu.pl / jaku6p@gmail.com )
# Last Modified On : 01.06.2024 
# Version          : 1.3
v="1.3"
#
# Description      : Projekt polega na zmianie tapety urządzenia na podstawie aktualnej pogody oraz kilku zadaniom pobocznym
# Opis
#
# Licensed Program opiera się na API ze strony OPENWHEATER.org, który na mocy licencji CC BY-SA 4.0.
